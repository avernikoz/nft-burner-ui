...
class RFirePlanePass {
  ...
  constructor(gl: WebGL2RenderingContext, inRenderTargetSize = { x: 512, y: 512 }) {
    ...
    //Create Shader Program
    this.shaderProgramFireUpdate = CreateShaderProgramVSPS(gl, ShaderSourceFullscreenPassVS, ShaderSourceFireUpdatePS);
  ...
  UpdateFire(gl: WebGL2RenderingContext) {
    ...
    gl.uniform1f(this.UniformParametersLocationListFireUpdate.NoiseTextureInterpolator, this.NoiseTextureInterpolator);
  ...
  VisualizeFire(gl: WebGL2RenderingContext, destFramebuffer: WebGLFramebuffer | null, destSize: Vector2) {
    ...
    //Constants
    gl.uniform1f(this.VisualizerUniformParametersLocationList.NoiseTextureInterpolator, this.NoiseTextureInterpolator);
