...
export const AfterBurnAshesParticlesDesc = {
    ...
    inBuoyancyForceScale: 1.0,
    inDownwardForceScale: 5.1,
    inRandomSpawnThres: 0.9,
...
export const EmberParticlesDesc = {
    ...
    inSizeRangeMinMax: { x: 0.5, y: 1.1 },
    inRandomSizeChangeSpeed: 0.1,
    inSizeClampMax: { x: 0.0, y: 0.0 },
    inInitialVelocityScale: 70.0,
    inVelocityFieldForceScale: MathLerp(70.0, 200.0, Math.random()),
    inBuoyancyForceScale: 2.0,
