...
export const EmberParticlesDesc = {
    ...
    inInitialVelocityScale: MathLerp(30.0, 50.0, Math.random()),
...
export const AfterBurnAshesPreloaderParticlesDesc = {
    inName: "Preloader Ashes Particles",
    inNumSpawners2D: 16,
    inNumParticlesPerSpawner: 1,
