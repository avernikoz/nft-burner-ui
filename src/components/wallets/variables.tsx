...
export function createMenuItems(
    ...
    return [
        {
            label: "Ethereum",
            icon: <EthereumLogo width={30} height={30} style={{ marginRight: "10px" }} />,
            command: () => {
        ...
        {
            label: "Polygon",
            icon: <PolygonLogo width={30} height={30} style={{ marginRight: "10px" }} />,
            command: () => {
        ...
        {
            label: "Arbitrum",
            icon: <ArbitrumLogo width={30} height={30} style={{ marginRight: "10px" }} />,
            command: () => {
        ...
        {
            label: "Optimism",
            icon: <OptimismLogo width={30} height={30} style={{ marginRight: "10px" }} />,
            command: () => {
        ...
        {
            label: "Sui",
            icon: <SuietLogo width={30} height={30} style={{ marginRight: "10px" }} />,
            command: () => {
        ...
        {
            label: "Solana",
            icon: <SolanaLogo width={30} height={30} style={{ marginRight: "10px" }} />,
            command: () => {
                // TODO: Replace with more descriptive condition
                if (activeIndex !== 5) {
                    disconnect();
